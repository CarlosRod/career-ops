...
process_offer() {
  ...
  local prompt
  prompt="Process this job offer. Execute the full consultancy pipeline: roster scoring + report .md + per-consultant PDFs + per-consultant tracker lines (see batch-prompt.md)."
